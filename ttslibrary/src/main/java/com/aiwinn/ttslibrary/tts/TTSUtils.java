package com.aiwinn.ttslibrary.tts;
...
public final class TTSUtils {
     ...
     * @param context 上下文
     */
    public static void onInitSpeech(Context context) {
     ...
     * @param str 需要播报的字符串
     */
    public static void onStartSpeech(String str, int type) {
        if (null != mSpeech) {
    ...
    /**
     * 释放资源操作
     * 调用此方法后，需要调用{@link #onInitSpeech(Context)}方法进行重新初始化
     */
