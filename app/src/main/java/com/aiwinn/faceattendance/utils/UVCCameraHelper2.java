...
public class UVCCameraHelper2 {
    ...
    public void createUVCCamera() {
        ...
        ((UVCCameraTextureView) mCamView).setDisplayOrientation(mDegree);
        mCameraHandler = UVCCameraHandler.createHandler(mActivity, mCamView, 2,
                previewWidth, previewHeight, mFrameFormat, mBandwidth);
    }
    ...
    public void setDisplayOrientation(int degree){
        if(mUSBMonitor != null) {
            throw new IllegalStateException("setDisplayOrientation should be call before initMonitor");
        }
        this.mDegree = degree;
    }

    public void setDefaultBandwidth(float bandwidth) {
        if (this.mUSBMonitor != null) {
            throw new IllegalStateException("setDefaultBandwidth should be call before initMonitor");
        } else {
